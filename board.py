...
class City:
    ...
    def get_railway_length(self, destination):
        railway = self.get_railway(destination)
        return railway.length if railway else None

    def get_railway_color(self, destination):
        railway = self.get_railway(destination)
        return railway.color if railway else None

    def get_railway(self, destination):
